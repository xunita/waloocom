      ...
      <div class="flex align-center justify-between">
        <div class="flex flex-col space-y-0">
          <div class="flex align-center pb-1">
            <a class="clickable flex align-center hover-004e66">
              <span class="size-12 makeme-004e66 font-semibold over maxwidth"
                >Waloo</span
              ></a
            ><svg
              class="w-3 h-3 mt-px logo-color cursor-default mx-px"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            ...
            <a
              class="clickable flex cursor-default color-004e66 align-center hover-004e66"
            >
              <span class="size-12 color-004e66 font-semibold over maxwidth">{{
                slug.title
              }}</span></a
            >
          </div>
          ...
          >
          <span v-if="slug" class="size-16 font-semibold pt-1">{{
            slug.title
          }}</span>
        </div>
