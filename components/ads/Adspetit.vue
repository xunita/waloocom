<template>
  <div class="adlines relative flex align-center justify-between">
    ...
    <div
      class="bg-white h-full w-full flex align-center space-x-2 absolute overflow-x-auto xxx scrollnone pt-2 rounded-bl rounded-br"
    >
      <Articlepetit v-for="i in 8" :key="i" />
    </div>
