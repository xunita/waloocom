<template>
  ...
  <div v-else class="adlines relative flex align-center justify-between">
    <div class="h-fit bg-transparent w-16 leftag z-10 px-2">
      ...
      >
        <svg
          class="w-4 h-4 transform rotate-90 color-white me-white"
          fill="currentColor"
          viewBox="0 0 20 20"
    ...
    >
      <Articlepetitsame v-for="i in 18" :key="i" />
    </div>
    <div class="h-fit bg-transparent w-16 rightag z-10 relative">
      ...
      >
        <svg
          class="w-4 h-4 transform -rotate-90 color-white relative me-white"
          fill="currentColor"
          viewBox="0 0 20 20"
          xmlns="http://www.w3.org/2000/svg"
        >
